  ...
  return (
    <div className="App">
      <div className="button-container">
        <button onClick={() => window.open(`https://example-shop.com/shop?text=${encodeURIComponent(affirmation.main)}&color=${encodeURIComponent(bgColor)}`, "_blank")}>Shop This Motif</button>
